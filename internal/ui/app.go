...
// App is the main Turbo F77 IDE application controller
type App struct {
	screen      tcell.Screen
	running     bool
	width       int
...
// StartDebugging initiates a debug session on current file
...
func (a *App) Redraw() {
	...
	a.statusBar.SetCursorCol(a.editor.CursorX + 1)
